...
const CONTACT_INFO = {
  ...
  googleMapsEmbed: 'https://maps.google.com/maps?q=Keshav+Enterprises+Shamli+Uttar+Pradesh&t=&z=15&ie=UTF8&iwloc=&output=embed',
  tradeindia: 'https://www.tradeindia.com/keshav-enterprises-73664698/product-services.html',
  exportersindia: 'https://www.exportersindia.com/keshav-enterprises-shamli/about-us.htm',
  justdial: 'https://www.justdial.com/Shamli/Keshav-Enterprises-Near-Subash-Ki-Chakki-Dayanand-Nagar/9999PX131-X131-230101014709-T5P8_BZDET/products-Turbine-Spare-Part?pid=&nid=&jdmid=&showSearch=0',
  // ── SOCIAL MEDIA ──
...
const RAW_PRODUCTS = [
  ...
  {
    id: 'prod_ee1', category: 'Electronic Equipments', title: 'Vibration Monitoring Probes (Shinkawa-compatible)',
...
// ── PASTE BEFORE THE CLOSING ]; OF RAW_PRODUCTS ──
// Products 1–7 of 13 new products (May 2026)

  {
    ...
    usage: 'Liquid and gas filtration in water treatment, oil and gas processing, chemical plants, food and beverage, and industrial pipeline strainer housings where backwashable and reusable elements are required.',
    features: [
    ...
    specs: {
      ...
      'Temperature Range': 'Up to 260 deg C (synthetic seals); up to 815 deg C (metallic connections)',
...

  {
    ...
    usage: 'Suction, pressure, and return line filtration in concrete pump hydraulic circuits on Schwing, Putzmeister, Sany, CIFA, and Zoomlion concrete pumps. Protects hydraulic pistons, control valves, and pump internals from particle-induced wear.',
    features: [
...

  {
    ...
    usage: 'Particulate capture in cement plant dust collectors, steel mill fume extraction, grain handling, chemical plant dust control, woodworking, metalworking, pharmaceutical manufacturing, and general industrial air filtration systems.',
    features: [
    ...
    specs: {
      ...
      'Operating Temperature': 'Up to 82 deg C (standard); 200 deg C+ (specialty media)',
...

  {
    ...
    usage: 'Replacement filter cartridges for flange-type dust collector housings in cement, power, steel, pharmaceutical, food processing, and chemical industries. Compatible with Donaldson Torit, Camfil Farr, and other major OEM flange-mount collectors.',
    features: [
    ...
    specs: {
      ...
      'Operating Temperature': 'Up to 93 deg C (standard); higher with specialty media',
...

  {
    ...
    usage: 'Replacement strainer elements for Y-type, basket, and pot strainers in ship fuel oil systems (heavy oil C), turbine lube oil suction lines, hydraulic circuits, food processing lines, and industrial pipeline strainers where cleanable, semi-permanent elements are preferred.',
    features: [
...

  {
    ...
    usage: 'Downstream of oil-flooded rotary screw and reciprocating compressors, turbine crankcase vents, gearbox breathers, and large rotating machine lubrication systems where oil mist must be captured before discharge to atmosphere or clean process air.',
    features: [
    ...
    specs: {
      ...
      'Max Operating Temperature': 'Up to 105 deg C continuous; 120 deg C short-term',
...

  {
    ...
    usage: 'Hydraulic and lubrication systems using HYDAC filter housings across industrial machinery, turbine control oil circuits, injection moulding machines, machine tools, and mobile hydraulic equipment.',
    features: [
...
// Products 8–13 of 13 new products (May 2026)

  {
    ...
    usage: 'Hydraulic power units, turbine lube and control oil systems, aerospace ground support, industrial machinery, and process filtration systems using Pall filter housings where cost-effective OEM-equivalent elements are required.',
    features: [
...

  {
    ...
    usage: 'Hydraulic and lube oil systems across Indian industry using Bhagwati filter housings — machine tools, injection moulding, industrial presses, CNC machinery, turbine auxiliary systems, and general hydraulic power units across sugar mills, paper mills, and process plants.',
    features: [
...

  {
    ...
    usage: 'Primary air-oil separation in oil-flooded rotary screw compressors (Atlas Copco, Kaeser, Ingersoll Rand, Elgi, Kirloskar, and all major brands). Protects downstream compressed air equipment and prevents excessive oil consumption.',
    features: [
    ...
    specs: {
      ...
      'Max Operating Temperature': 'Up to 110 deg C (continuous); 120 deg C (peak)',
      'Collapse Resistance': 'Minimum 5 bar (70 psi) differential',
      'Service Life': '2000–4000 operating hours',
      'Compatible Brands': 'Atlas Copco, Kaeser, Ingersoll Rand, Elgi, Kirloskar, Chicago Pneumatic',
...

  {
    ...
    usage: 'Turbine coupling overload protection on Triveni, BHEL, Siemens, KKK, Man Turbo, and Belliss & Morcom steam turbines. Installed in coupling flanges between turbine and gearbox, or gearbox and driven equipment — sugar mill crushers, pumps, fans, and compressors.',
    features: [
...

  {
    ...
    usage: 'Turbine auxiliary hydraulic systems, machine tool hydraulic power units, industrial presses, injection moulding machines, and mobile hydraulic equipment using Dowty 0P, 1P, 2P, or 3P series gear pumps.',
    features: [
...

  {
    ...
    usage: 'Hydraulic system directional flow control in turbine auxiliary systems, industrial presses, injection moulding machines, steel plant hydraulics, sugar mill hydraulic drives, machine tools, and all industrial hydraulic power units requiring 4/2, 4/3, or 5/2 directional valve control.',
    features: [
...
const LanguageSwitcher = memo(({ scrolled }) => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <span aria-hidden="true" className="text-base leading-none">{activeLang.flag}</span>
        <span className="hidden xl:inline-block">{activeLang.code.toUpperCase()}</span>
          ...
          <div className="max-h-80 overflow-y-auto py-2 scrollbar-hide">
            {LANGUAGES.map(lang => (
              ...
              >
                ...
                {lang.name}
                {currentLang === lang.code && <CheckCircle2 className="w-4 h-4 ml-auto text-blue-500" aria-hidden="true" />}
              </button>
            ))}
          </div>
        </div>
...
const Navbar = memo(({ currentPath, navigate }) => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (currentScrollY < 100 || isOpen || isSearchOpen) {
        setIsVisible(true);
      } else {
        setIsVisible(false);
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <h2 className="text-white font-serif italic text-2xl md:text-3xl tracking-wide mb-2 drop-shadow-md">Need a quote or have an emergency breakdown?</h2>
            <p className="text-blue-200 font-mono text-sm tracking-wide uppercase font-semibold drop-shadow-sm">Our engineering team responds within 24 hours</p>
          </div>
          <div className="flex flex-wrap gap-4 shrink-0 justify-center">
            <a href={`tel:${CONTACT_INFO.phones[0].replace(/\s/g,'')}`}
              ...
              <Phone className="w-5 h-5 text-blue-300 group-hover:text-white shrink-0" aria-hidden="true" />{CONTACT_INFO.phones[0]}
            </a>
            <a href={waMsg('Hi KESHAV ENTERPRISES, I would like to request a technical quote.')}
              ...
              <MessageCircle className="w-5 h-5 shrink-0" aria-hidden="true" />WhatsApp Now
            </a>
          </div>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-12 gap-y-16 mb-20">
        ...
        <div className="lg:col-span-4">
            ...
            {[
              ...
              <div key={title} className="flex items-center gap-5 bg-slate-900 border border-slate-800 hover:border-blue-500/50 hover:bg-slate-800 shadow-md rounded-2xl p-4 w-fit transition-all hover:translate-x-2">
                ...
                <div>
                  ...
                  <p className="text-blue-400 font-mono text-xs tracking-widest">{sub}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* OEM compatibility */}
          <p className="font-bold text-[10px] text-blue-500 uppercase tracking-[0.2em] mb-2">OEM Compatible With</p>
            ...
            {NAV_LINKS.map(link => (
              <li key={link.name}>
                <a href={`#${link.path}`}
                  ...
                  <ChevronRight className="w-4 h-4 text-blue-500/50 group-hover:text-blue-400 transition-colors" aria-hidden="true" />
                  <span>{link.name}</span>
                </a>
              </li>
            ))}
            ...
            {[
              ...
              <li key={id}>
                <a href={`#/service/${id}`}
                  ...
                  className="text-slate-400 hover:text-white font-medium text-sm transition-colors flex items-center gap-3 group focus:outline-none w-fit">
                  <Hexagon className="w-3.5 h-3.5 text-blue-500/50 group-hover:text-blue-400 transition-colors" aria-hidden="true" />
                  <span>{label}</span>
                </a>
              </li>
            ))}
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div className="flex flex-col gap-1.5 mt-1">
                {CONTACT_INFO.phones.map(p => (
                  <a key={p} href={`tel:${p.replace(/\s/g,'')}`} className="text-slate-300 hover:text-white font-mono text-sm transition-colors focus:outline-none focus-visible:underline">
                    {p}
                  </a>
                ))}
              </div>
      ...
      <div className="mb-14">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
          {[
            { href: CONTACT_INFO.linkedin,  label: `LinkedIn — ${CONTACT_INFO.linkedinHandle}`,  name: 'LinkedIn',   bg: '#0A66C2' },
            { href: CONTACT_INFO.youtube,   label: `YouTube — ${CONTACT_INFO.youtubeHandle}`,   name: 'YouTube',    bg: '#FF0000' },
            { href: CONTACT_INFO.instagram, label: `Instagram — ${CONTACT_INFO.instagramHandle}`, name: 'Instagram', bg: '#E1306C' },
            { href: CONTACT_INFO.facebook,  label: `Facebook — ${CONTACT_INFO.facebookHandle}`,  name: 'Facebook',   bg: '#1877F2' },
            { href: CONTACT_INFO.twitter,   label: `X — ${CONTACT_INFO.twitterHandle}`,          name: 'X',          bg: '#000000' },
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 mb-10">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="lg:text-right shrink-0">
            ...
            <p className="text-white font-black text-3xl tracking-tight">5 kW <span className="text-slate-600 font-normal mx-1">–</span> 27 MW</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-slate-800">
        ...
        <p className="text-slate-400 text-sm flex items-center gap-2">
          <span>GST:</span>
          <span className="text-slate-300 font-mono bg-slate-900 px-2 py-0.5 rounded border border-slate-800">{CONTACT_INFO.gst}</span>
        </p>
      </div>
    </div>
  </footer>
    ...
    <section aria-labelledby="digital-profiles-heading" className="bg-slate-50 py-14 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="text-xs font-black text-slate-500 uppercase tracking-[0.25em] mb-3">Find Us Everywhere</p>
          <h2 id="digital-profiles-heading" className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight mb-3">
          ...
          {profiles.map((p) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-[11px] font-black mt-1 px-2 py-0.5 rounded-full w-fit"
                  style={{ color: p.badgeColor, backgroundColor: p.badgeBg }}>
                  {p.badge}
                </span>
              </div>
              <ExternalLink className="w-3.5 h-3.5 text-slate-300 group-hover:text-blue-400 transition-colors ml-auto shrink-0" aria-hidden="true" />
            </a>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-5 shadow-sm">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 border border-slate-100" style={{ backgroundColor: '#e8f0fe' }}>
            ...
            <div className="flex-1 text-center sm:text-left">
              <h3 className="font-black text-slate-900 text-lg mb-1">Find Us on Google Business</h3>
              <p className="text-slate-500 font-medium text-sm leading-relaxed">
                Search <strong className="text-slate-700">"Keshav Enterprises Shamli"</strong> on Google Maps — view our profile, get directions, or leave a review to help other buyers find us.
              </p>
            </div>
            <a href={CONTACT_INFO.googleBusiness} target="_blank" rel="noopener noreferrer"
